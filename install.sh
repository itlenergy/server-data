...
gosu postgres postgres --single -j <<- "EOSQL"
  ...
  INSERT INTO login_user(username, password, role, related_id) VALUES ('admin', E'\\xA90DF67816FD16F347F5D8B9D7EE55FBBBF4F92D6D104348282E41CEA8DC7F6A5B5037E585E2FE1AF240B1965055ED7E1F3F9687D18D0380B7F10BFDE5BE74EC','admin',NULL);
EOSQL

echo "Default admin user created with username=admin and password=admin - change this password as soon as possible"
